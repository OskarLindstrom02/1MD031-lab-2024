...
<div>
    <header>
        <img src="https://t4.ftcdn.net/jpg/07/78/23/41/360_F_778234167_Wcm57Vq9GivIZLW5Qd3p2OUBQ0JGOXS1.jpg">
    ...
    <p>
        ...
        <input type="text" id="name" v-model="name" required placeholder="First- and Last name">
    ...
    <p>
        ...
        {{ gender }} <!-- Lägg till detta för att testa -->
    </p>
    <p>
    ...
    <h2>Delivery Map</h2>
   <div class="map-container" v-on:click="setLocation">
    <img id="map" src="/img/polacks.jpg" alt="Delivery Map" width="1920" height="1078">
    <div class="target" v-bind:style="{ left: location.x + 'px', top: location.y + 'px' }">
        ...
        <button type="button" v-on:click="submitOrder">
          <img src="https://img.myloview.se/fototapeter/check-icon-vector-check-mark-icon-check-list-button-icon-700-194930748.jpg" alt="Submit" width="20" height="20">
        Place order
    </button>
    </main>
...
const burgers = [
  new Menultem("Double burger", "https://images.arla.com/recordid/02F90FAA-0208-47E9-A76D3510DDFDA427/smashburger.jpg", 300, false, true),
  new Menultem("Big burger", "https://images.themodernproper.com/production/posts/2016/ClassicCheeseBurger_9.jpg?w=1200&h=1200&q=60&fm=jpg&fit=crop&dm=1749310239&s=463b18fc3bb51dc5d96e866c848527c4", 400, true, false),
  new Menultem("Chicken burger", "https://www.recipetineats.com/tachyon/2023/09/Crispy-fried-chicken-burgers_5.jpg", 500, true, true)
];
...
button:hover {
    background-color: #1287b6; /* Mörkare grön när man hovrar */
